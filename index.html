...
<section class="section" id="app">
	<transition name="fade" mode="out-in">
	    <div key="1" v-if="!sessionsStarted" class="container box">
			<h1 class="title">
				Pamadoro
			</h1>
			<p class="subtitle">
			...
			<button class="button is-primary" @click="sessionsStarted = true"
			>Start</button>
	    </div>
	    <div key="2" v-if="sessionsStarted" class="container box">
			<h1 class="title">
				Pamadoro
			</h1>
			<p class="subtitle">
